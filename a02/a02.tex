...
\begin{enumerate}
    ...
    Si el sistema detecta una variación en la velocidad del motor mayor al 5% de la velocidad deseada, el sistema deberá ajustar el voltaje en menos de 100 ms.
